            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <div class="box" style="max-height: 450px; overflow-y: auto;">
                        ...
                        <div class="box-header with-border">
                            <h4 class="box-title">供货商11: {{communityList.length}}家</h4>
                        </div>
                ...
                <div class="col-md-10">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <OfSupplierPanel :nxSupplierId ="nxSupplierId" :nxSupplierName="nxSupplierName"/>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    import OfSupplierPanel from '@/components/OutGoodsManagement/OfSupplier/OfSupplierPanel'

    export default {
        name: "OutGoodsOfSupplier",
