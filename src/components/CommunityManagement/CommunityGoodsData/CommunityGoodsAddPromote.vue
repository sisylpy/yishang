    ...
    <transition name="confirm-fade">
        <div v-if="isShowConfirm" class="my-confirm" @click.stop="clickFun('clickCancel')">
            <div class="confirm-content-wrap" @click.stop>
                <h3 class="my-confirm-title">{{  }}</h3>

                <div class="my-confirm-content">
                    <CommunityGoodsAddPromoteContent
                            :nxCgGoodsId="nxCgGoodsId"   @hidden="hidden"/>
                </div>
...
<script type="text/ecmascript-6">
    import CommunityGoodsAddPromoteContent from '@/components/CommunityManagement/CommunityGoodsData/CommunityGoodsAddPromoteContent.vue'

    export default {
        name: "CommunityGoodsAddPromote",
        data () {
            return {
        ...
        methods: {
            show (content, config) {
                ...
                if (Object.prototype.toString.call(config) === '[object Object]') {
                    ...
                    this.nxCgGoodsId = config.nxCgGoodsId
