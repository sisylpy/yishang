    ...
    <transition name="confirm-fade">
        <div v-if="isShowConfirm" class="my-confirm" @click.stop="clickFun('clickCancel')">
            <div class="confirm-content-wrap" @click.stop>
                <h3 class="my-confirm-title">{{ titleText }} ({{standard}})</h3>

                <div class="my-confirm-content">
                    <AddCommunityNewGoodsContent :nxGoodsId="nxGoodsId" @hidden="hidden"/>
...
<script type="text/ecmascript-6">
    import AddCommunityNewGoodsContent from '@/components/CommunityManagement/CommunityGoodsData/AddCommunityNewGoodsContent.vue'

    export default {
        name: "AddCommunityGoods",
        ...
        watch: {
            updateba: function (newVal) {

                if (newVal) {
                    console.log("update")
                    this.$parent.$data.letUpdate = true
                }
            }
        ...
        methods: {
            show (content, config) {
                ...
                if (Object.prototype.toString.call(config) === '[object Object]') {
                    ...
                    this.nxGoodsId = config.nxGoodsId
