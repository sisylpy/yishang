<template>
    ...
    <div class="content">
                ...
                <div class="box-body no-padding">
                    <ul class="nav nav-pills nav-stacked" id="products">
                        ...
                        <li v-for="(item,index) in goodsArr" v-bind:key="item.id" :id="item.goodsId"
                            ...
                            @click='onclickProducts(index, item.goodsId,item.goodsName)'>
                            <a>{{item.goodsName}} {{item.price}}/{{item.purStandardName}}</a></li>
                    </ul>
                </div>
                <!-- /.box-body -->
            </div>
        ...
        <!-- /.col -->
        <div class="col-md-10">
            <HandlingTypeGoodsTable :fatherId="fatherId" :fatherName="fatherName"
