<template>
    ...
    <div class="content container-fluid box box-default" id="jqbody">
                ...
                $("#handlingTable").jqGrid(
                    {
                        ...
                        colModel: [
                            ...
                            {label: '出货部门', name: 'outDepEntity.depName', width: 120},
                            {label: '采购部门', name: 'purDepEntity.depName', width: 120},
                            {label: '拼音', name: 'pinyin', width: 160},
                            {label: '简拼', name: 'headPinyin', width: 100},
