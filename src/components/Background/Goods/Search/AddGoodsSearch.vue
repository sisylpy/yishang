<template>
    ...
    <div class="my-modal-back" id="modal_search">
        <div class="my-modal">
            <div class="">
                <div class="">
                ...
                <div class="my_modal_body">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-sm-2 control-label">所属大类xxxx</div>
                            <div class="col-sm-10">
    ...
    export default {
        ...
        watch: {
            ...
            addGoods: function (newVal, oldVal) {
                ...
                if(newVal == 1) {
                    ...
                    var goodsId = $('#modal_search').attr('goodsid');
        ...
        methods: {
            getFatherList: function () {
                console.log("getfatherhehrheh")
                api.queryTypeFatherList(0).then(res => {
                    if (res) {
